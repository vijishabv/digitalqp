...
@Component({
  selector: 'app-qpviewjs',
  templateUrl: './qpviewjs.component.html',
  styleUrls: ['./qpviewjs.component.css']
})
export class QpviewjsComponent {
  ...
  //function to display questions one by one
   displayquestion(){
    if(this.answer==""){
      ...
      this.i=this.i-1
      this.router.navigateByUrl("javascript")
    }
